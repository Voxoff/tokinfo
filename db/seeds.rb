...
# admin account for easy access
  admin = User.create!(first_name: "Alex", second_name: "Benoit" email: "admin@admin.com", password: "123123", remote_photo_url: "https://media.licdn.com/mpr/mpr/shrinknp_200_200/AAEAAQAAAAAAAAbDAAAAJDMzNzE3YWY3LTc0MWMtNGNjNi04M2QxLTQ2YWE3NDY5NThkZg.jpg")
...
data["Data"].each_with_index do |(key,value), i|
  ...
  if i < 5
    ...
    user = User.create!(first_name: fnames[i], last_name: snames[i],  email: sname[i] + "@hotmail.com", password: "123123", remote_photo_url: "https://source.unsplash.com/random/400x400&sig=#{i}&smile")
